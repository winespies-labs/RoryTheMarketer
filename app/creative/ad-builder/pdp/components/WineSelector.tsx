...
import type { WineAdContext, VarietalClassification } from "../../_shared/wineAdContext";
import type {
  ChannelFilter,
...
function ChannelBadge({ channel }: { channel: "featured" | "store" }) {
  return (
    <span
    ...
    >
      {channel === "featured" ? "Featured" : "Store"}
    </span>
  );
}
      ...
      <div className="p-3 flex gap-3">
        ...
        <div className="flex-1 min-w-0 pt-1">
          <div className="flex items-start gap-1.5 mb-1">
            ...
            {context.has_score && context.score && context.score_label && (
              <ScoreBadge score={context.score} label={context.score_label} />
            )}
          </div>

          <div className="text-[11px] text-muted font-medium mb-0.5">
            {context.producer}
          </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="flex rounded-lg border border-border overflow-hidden text-sm">
          {(
            ...
            ] as { value: ChannelFilter; label: string }[]
          ).map((opt) => (
            <button
